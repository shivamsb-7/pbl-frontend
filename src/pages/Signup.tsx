...
export default function Signup() {
  ...
  const inputClass =
    "w-full px-4 py-3 rounded-xl border border-slate-300 bg-white text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-violet-500 transition";
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 py-10">
      ...
      <button
        onClick={toggleTheme}
        className="fixed top-4 right-4 p-2 rounded-lg bg-violet-50 border border-violet-200 text-violet-600 hover:bg-violet-100 transition focus:outline-none focus:ring-2 focus:ring-violet-500"
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 mt-1">Join the notices portal</p>
        </div>

        {/* Card */}
        <div className="bg-white border border-slate-200 rounded-2xl p-8 space-y-4 shadow-2xl">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
               <label className="block text-sm font-medium text-slate-700 mb-1.5">
                 Class <span className="text-slate-500 font-normal">(student)</span>
              </label>
            ...
            <div>
               <label className="block text-sm font-medium text-slate-700 mb-1.5">
                 Batch <span className="text-slate-500 font-normal">(student)</span>
              </label>
          ...
          <button
            onClick={signup}
            disabled={loading}
            className="w-full flex items-center justify-center gap-2 bg-violet-600 hover:bg-violet-500 text-white py-3 rounded-xl font-semibold transition duration-200 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-violet-400/40 mt-2"
          >
